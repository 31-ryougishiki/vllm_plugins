...
def init_zero_interrupt():
    ...
    from vllm_custom_plugins.plugins.zero_interrupt.vllm.v1.executor.its_multiproc_executor import ITSMultiprocExecutor
    from vllm_custom_plugins.plugins.zero_interrupt.vllm.v1.executor import ITSNPUWorker
