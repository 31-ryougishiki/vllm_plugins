...
from vllm_custom_plugins.plugins.zero_interrupt.deepseekv4.common.types import DeployState, DeployStrategy, DeployType, ExecutorState, EngineParallelConfig, \
    InitExecutorStateRequest, ModelInfo

from vllm_custom_plugins.plugins.zero_interrupt.deepseekv4.common.communication.decision_center_client import DecisionCenterClient
...
from vllm_custom_plugins.plugins.zero_interrupt.deepseekv4.common import StrategyHandler
...
class ITSMultiprocExecutor(AscendMultiprocExecutor):
    ...
    def _to_heterogeneous_dp_config(configs: list[dict]):
        ...
        try:
            ...
            from vllm_custom_plugins.plugins.zero_interrupt.deepseekv4.vllm.config.parallel import (
