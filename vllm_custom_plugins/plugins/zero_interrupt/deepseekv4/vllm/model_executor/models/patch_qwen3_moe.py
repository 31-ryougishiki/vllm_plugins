...
from vllm_custom_plugins.plugins.zero_interrupt.deepseekv4.vllm.model_executor.layers.patch_vocab_parallel_embedding import (
...
from vllm_custom_plugins.plugins.zero_interrupt.deepseekv4.vllm.v1.executor.utils import get_tp_asymmetric_shardings
...
class Qwen3MoeForCausalLMAsymmtric(
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self.model = Qwen3MoeModelAsymmtric(
            vllm_config=vllm_config, prefix=maybe_prefix(prefix, "model")
        )

        # 选择支持非对称的lmhead TODO: 缺少判断使用哪个类的条件
        vllm_config = get_current_vllm_config()
        additional_config = getattr(vllm_config, "additional_config", None)
        zero_interrupt_config = additional_config.get("zero_interrupt_config", None)
        asym = zero_interrupt_config is not None
