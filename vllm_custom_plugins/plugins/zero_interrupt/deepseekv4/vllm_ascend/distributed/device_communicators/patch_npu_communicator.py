...
from vllm_custom_plugins.plugins.zero_interrupt.deepseekv4.vllm.distributed.device_communicators.patch_base_device_communicator import PatchDeviceCommunicatorBase


class PatchNPUCommunicator(PatchDeviceCommunicatorBase, DeviceCommunicatorBase):
    def __init__(
        self,
